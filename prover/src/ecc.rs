...
//     #[derive(Debug, Eq, PartialEq, Clone)]
//     pub(crate) struct FullWidth(jubjub::Affine, &'static [(u64, [jubjub::Base; H])]);
//     #[derive(Debug, Eq, PartialEq, Clone)]
...
//
//     lazy_static! {
//         static ref BASE: jubjub::Affine = jubjub::Point::generator().to_affine();
//         static ref ZS_AND_US: Vec<(u64, [jubjub::Base; H])> =
//             find_zs_and_us(*BASE, NUM_WINDOWS).unwrap();
//         static ref ZS_AND_US_SHORT: Vec<(u64, [jubjub::Base; H])> =
...
//             base: jubjub::Affine,
//             zs_and_us: &'static [(u64, [jubjub::Base; H])],
//         ) -> Self {
//             FullWidth(base, zs_and_us)
//         }
//     }
//
//     impl FixedPoint<jubjub::Affine> for FullWidth {
//         type FixedScalarKind = FullScalar;
//
//         fn generator(&self) -> jubjub::Affine {
//             self.0
//         }
//
...
//     }
//
//     impl FixedPoint<jubjub::Affine> for BaseField {
...
//     }
//
//     impl FixedPoint<jubjub::Affine> for Short {
...
//     }
//
//     impl FixedPoints<jubjub::Affine> for TestFixedBases {
...
//             let p_val = jubjub::Point::random(rand::rngs::OsRng).to_affine(); // P
...
//             let q_val = jubjub::Point::random(rand::rngs::OsRng).to_affine(); // Q
...
//                     Value::known(jubjub::Affine::identity()),
//                 )?;
//
