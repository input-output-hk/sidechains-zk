...
//
//         {
//             let circuit: MyCircuit<jubjub::Base> = MyCircuit {
//                 num_words: 6,
//                 _marker: PhantomData,
//             };
//
...
//         {
//             let circuit: MyCircuit<jubjub::Base> = MyCircuit {
//                 element: Value::known(jubjub::Base::zero()),
//                 num_bits: 0,
//             };
//             let prover = MockProver::<jubjub::Base>::run(11, &circuit, vec![]).unwrap();
//             assert_eq!(prover.verify(), Ok(()));
...
//         {
//             let circuit: MyCircuit<jubjub::Base> = MyCircuit {
//                 element: Value::known(jubjub::Base::from((1 << K) - 1)),
//                 num_bits: K,
//             };
//             let prover = MockProver::<jubjub::Base>::run(11, &circuit, vec![]).unwrap();
//             assert_eq!(prover.verify(), Ok(()));
...
//         {
//             let circuit: MyCircuit<jubjub::Base> = MyCircuit {
//                 element: Value::known(jubjub::Base::from((1 << 6) - 1)),
//                 num_bits: 6,
//             };
//             let prover = MockProver::<jubjub::Base>::run(11, &circuit, vec![]).unwrap();
//             assert_eq!(prover.verify(), Ok(()));
...
//         {
//             let circuit: MyCircuit<jubjub::Base> = MyCircuit {
//                 element: Value::known(jubjub::Base::from(1 << 6)),
//                 num_bits: 6,
//             };
//             let prover = MockProver::<jubjub::Base>::run(11, &circuit, vec![]).unwrap();
//             assert_eq!(
...
//         {
//             let circuit: MyCircuit<jubjub::Base> = MyCircuit {
//                 element: Value::known(jubjub::Base::from(1 << K)),
//                 num_bits: 6,
//             };
//             let prover = MockProver::<jubjub::Base>::run(11, &circuit, vec![]).unwrap();
//             assert_eq!(
...
//         {
//             let num_bits = 6;
//             let shifted = jubjub::Base::from((1 << num_bits) - 1);
//             // Recall that shifted = element * 2^{K-s}
//             //          => element = shifted * 2^{s-K}
//             let element = shifted
//                 * jubjub::Base::from(1 << (K as u64 - num_bits))
//                     .invert()
//                     .unwrap();
//             let circuit: MyCircuit<jubjub::Base> = MyCircuit {
